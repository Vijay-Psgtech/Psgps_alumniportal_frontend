      ...
      <div className="px-7 pt-6 pb-7">
            ...
            <div className="flex gap-2.5 pt-1">
              {[
                ...
                <button
                  ...
                  disabled={isLoading}
                  className={`flex-1 py-2 rounded-xl border text-[13px] font-semibold font-['Outfit',sans-serif] transition-all
        ...
        <div className="flex gap-3 mt-6 pt-5 border-t border-slate-100">
          ...
          <button
            onClick={onClose}
            disabled={isLoading}
            className={`px-6 py-3 rounded-xl border border-slate-200 bg-slate-50 text-gray-400 font-['Outfit',sans-serif] text-sm font-semibold transition-all
        ...
        {!valid && (
          <p className="text-amber-500 text-xs mt-2 font-['Outfit',sans-serif]">
