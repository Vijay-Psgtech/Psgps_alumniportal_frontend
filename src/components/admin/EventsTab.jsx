    ...
    <div className="relative">
      ...
      <div className="flex flex-wrap items-center gap-2.5 mb-4 border-b border-transparent pb-1">
        ...
        <div className="flex bg-white border border-slate-200 rounded-xl overflow-hidden shadow-sm shadow-black/5">
          {["all", "upcoming", "completed"].map((f) => (
            <button
              ...
              className={`px-4 py-2 border-none font-['Outfit',sans-serif] text-xs font-bold transition-colors capitalize ${statusFilter === f ? "bg-[#0d2d52] text-white" : "bg-transparent text-gray-400 hover:bg-slate-50 hover:text-gray-600"}`}
            >
              {f}
            </button>
          ))}
        ...
        <button
          ...
          className="px-4 py-2.5 rounded-xl border-none bg-linear-to-br from-[#0d2d52] to-[#143d69] text-white font-['Outfit',sans-serif] text-[13px] font-bold cursor-pointer flex items-center gap-1.5 whitespace-nowrap shadow-md shadow-blue-500/25 transition-all hover:-translate-y-0.5 hover:shadow-blue-500/40"
        >
