    ...
    <div className="min-h-screen bg-linear-to-br from-slate-100 via-white to-blue-50 mt-16 p-4 sm:p-6 lg:p-24">
      ...
      {isFetching && (
        ...
        >
          <div className="text-center">
            ...
            />
            <p className="text-gray-600 font-['Outfit',sans-serif] font-medium">
              Loading events...
            </p>
          </div>
        </motion.div>
      ...
      <div className="mb-8">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
          <div>
            <h1 className="text-3xl sm:text-4xl font-['Playfair_Display',serif] font-extrabold text-[#0c0e1a] mb-2">
              Events Management
            </h1>
            <p className="text-gray-500 font-['Outfit',sans-serif] text-sm">
      ...
      <AnimatePresence>
        {notification && (
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            exit={{ opacity: 0, y: -20 }}
            className={`mb-6 p-4 rounded-xl border flex items-center gap-3 font-['Outfit',sans-serif] ${
      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-4 sm:p-6 mb-6 shadow-sm shadow-black/5">
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col sm:flex-row gap-3 items-stretch sm:items-center">
            <div className="flex-1 relative">
              ...
              <input
                ...
                className="w-full py-3 px-4 pl-10 border border-slate-200 rounded-xl font-['Outfit',sans-serif] text-sm outline-none bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all"
              />
            </div>
          </div>
          ...
          {viewMode === "table" && (
            <div className="flex flex-col sm:flex-row gap-3 items-stretch sm:items-center">
              <div className="text-xs font-semibold text-gray-600 font-['Outfit',sans-serif] uppercase tracking-wider">
                Sort By:
              </div>
              <div className="flex gap-2 flex-wrap">
                {[
                  ...
                  <button
                    ...
                    className={`px-3 py-2 rounded-lg text-xs font-bold font-['Outfit',sans-serif] border transition-all flex items-center gap-1 ${
                      sortBy === option.value
          ...
          <div className="flex flex-col sm:flex-row gap-3 items-stretch sm:items-center justify-between">
            ...
            <div className="flex items-center gap-3 flex-wrap sm:flex-nowrap justify-between sm:justify-end">
              <div className="text-xs text-gray-500 font-['Outfit',sans-serif] font-medium whitespace-nowrap">
                Showing{" "}
      ...
      <div className="space-y-4">
        {sorted.length === 0 ? (
          ...
          >
            ...
            <h3 className="text-lg font-bold text-gray-700 font-['Outfit',sans-serif] mb-1">
              No events found
            </h3>
            <p className="text-sm text-gray-500 font-['Outfit',sans-serif]">
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-4 pb-4 border-b border-slate-100">
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-2 mb-2">
                          {event.highlight && (
                            <div className="flex items-center gap-1 bg-amber-50 text-amber-600 px-2 py-1 rounded-full border border-amber-200">
                              ...
                              />
                              <span className="text-[10px] font-bold font-['Outfit',sans-serif]">
                                Featured
                              </span>
                            </div>
                          )}
                          <h3 className="text-lg font-bold text-[#0c0e1a] font-['Playfair_Display',serif] line-clamp-2">
                            {event.title}
                          </h3>
                        </div>
                        ...
                        <div className="flex flex-wrap items-center gap-2">
                          <span
                            className="inline-block rounded-full px-3 py-1 text-[10px] font-bold font-['Outfit',sans-serif] tracking-wider border"
                            style={{
                              background: `${cc}15`,
                              color: cc,
                              borderColor: `${cc}30`,
                          ...
                          <span className="text-xs text-gray-500 font-['Outfit',sans-serif]">
                            {event.venue?.split(",")[0]}
                          </span>
                        </div>
                      </div>
                      ...
                      {/* Status Badge */}
                      <div
                        className={`flex items-center gap-1.5 px-3 py-1.5 rounded-full text-[11px] font-bold font-['Outfit',sans-serif] uppercase tracking-wider whitespace-nowrap border ${
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-5">
                      <div>
                        <p className="text-[10px] font-bold text-gray-400 uppercase tracking-wider font-['Outfit',sans-serif] mb-1">
                          Date
                        </p>
                        <p className="text-sm font-semibold text-[#0c0e1a] font-['Outfit',sans-serif]">
                          {fmtDate(event.date)}
                        </p>
                      </div>
                      <div>
                      ...
                      <div>
                        ...
                        <p className="text-sm font-semibold text-[#0c0e1a] font-['Outfit',sans-serif] truncate">
                    ...
                    {/* Description */}
                    {event.description && (
                      <p className="text-xs text-gray-600 font-['Outfit',sans-serif] line-clamp-2 mb-4 p-3 bg-slate-50 rounded-lg border border-slate-100">
                        {event.description}
                      </p>
                    )}
                    ...
                    <div className="flex gap-2 pt-3 border-t border-slate-100">
                      <button
                        ...
                        disabled={isLoading}
                        className="flex-1 px-4 py-2.5 border border-blue-200 hover:bg-blue-50 rounded-lg bg-white text-blue-600 font-['Outfit',sans-serif] text-sm font-bold flex items-center justify-center gap-2 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                      >
                        <Pencil size={14} /> Edit
                      </button>
                      <button
                        ...
                        disabled={isLoading}
                        className="flex-1 px-4 py-2.5 border border-red-200 hover:bg-red-50 rounded-lg bg-white text-red-600 font-['Outfit',sans-serif] text-sm font-bold flex items-center justify-center gap-2 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                      >
            ...
            {totalPages > 1 && (
              <div className="flex items-center justify-center gap-2 mt-6 flex-wrap">
                <button
                  ...
                  className="px-3 py-2 rounded-lg border border-slate-200 text-sm font-bold font-['Outfit',sans-serif] disabled:opacity-50 disabled:cursor-not-allowed hover:bg-slate-50"
                >
                  Previous
                </button>
                {Array.from({ length: totalPages }, (_, i) => i + 1).map(
                  (page) => (
                    <button
                      ...
                      className={`w-9 h-9 rounded-lg text-sm font-bold font-['Outfit',sans-serif] transition-all ${
                        currentPage === page
          ...
          <>
                  ...
                  <thead>
                    <tr className="bg-linear-to-r from-slate-50 to-blue-50 border-b border-slate-200">
                      <th className="px-6 py-4 text-left">
                        <span className="text-xs font-bold font-['Outfit',sans-serif] uppercase tracking-wider text-gray-600">
                          Event
                        </span>
                      </th>
                      <th className="px-6 py-4 text-left">
                        ...
                        >
                          ...
                          <td className="px-6 py-4">
                            <div className="flex items-center gap-3">
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                <div className="flex-1">
                                  <p className="text-sm font-bold text-[#0c0e1a] font-['Playfair_Display',serif] line-clamp-2">
                                    {event.title}
                                  </p>
                                </div>
                              </div>
                          ...
                          <td className="px-6 py-4 text-center">
                            <div>
                              ...
                              <p className="text-xs text-gray-500 font-['Outfit',sans-serif]">
                                {fmtTime(event.time)}
                              </p>
                            </div>
                          </td>
                          ...
                          {/* Attendees */}
                          <td className="px-6 py-4 text-center">
                            <div className="flex items-center justify-center gap-1 text-sm font-semibold text-[#0c0e1a] font-['Outfit',sans-serif]">
                          ...
                          <td className="px-6 py-4 text-center">
                            <div className="flex items-center justify-center gap-1">
                              ...
                              />
                              <p className="text-sm text-gray-600 font-['Outfit',sans-serif] truncate max-w-[120px]">
                                {event.venue?.split(",")[1] || "N/A"}
                              </p>
                            </div>
                          </td>
                          ...
                          <td className="px-6 py-4 text-center">
                            <span
                              className={`inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-[11px] font-bold font-['Outfit',sans-serif] uppercase tracking-wider border ${
                                event.status === "upcoming"
                                  ? "bg-emerald-50 text-emerald-700 border-emerald-200"
                                  : "bg-gray-50 text-gray-600 border-gray-200"
                              }`}
            ...
            {totalPages > 1 && (
              <div className="flex items-center justify-between bg-white rounded-2xl border border-slate-200 p-4 shadow-sm shadow-black/5">
                <div className="text-sm text-gray-600 font-['Outfit',sans-serif]">
                  ...
                  <select
                    ...
                    className="ml-3 px-2 py-1 border border-slate-200 rounded-lg font-['Outfit',sans-serif] text-sm bg-white outline-none focus:border-blue-500"
                  >
                    {[5, 10, 25, 50].map((size) => (
                    ...
                    {totalPages <= 5 ? (
                      Array.from({ length: totalPages }, (_, i) => i + 1).map(
                        (page) => (
                          <button
                            key={page}
                            onClick={() => setCurrentPage(page)}
                            className={`w-8 h-8 rounded-lg text-xs font-bold font-['Outfit',sans-serif] transition-all ${
                              currentPage === page
                                ? "bg-blue-500 text-white border border-blue-500"
                                : "border border-slate-200 hover:bg-slate-50"
                            }`}
                      ...
                      <>
                        <button
                          ...
                          className={`w-8 h-8 rounded-lg text-xs font-bold font-['Outfit',sans-serif] ${
                            currentPage === 1
                              ? "bg-blue-500 text-white border border-blue-500"
                              : "border border-slate-200 hover:bg-slate-50"
                          }`}
                        ...
                        {currentPage > 2 && currentPage < totalPages - 1 && (
                          <button
                            ...
                            className="w-8 h-8 rounded-lg text-xs font-bold font-['Outfit',sans-serif] bg-blue-500 text-white border border-blue-500"
                          >
                            {currentPage}
                          </button>
                        )}
